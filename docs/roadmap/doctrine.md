...
>
> Eduto nebude vítězit počtem funkcí. Bude vítězit množstvím práce, kterou škola už nemusí dělat ručně.
...
**Rozhodnutí:** Eduto nebude optimalizovat „čas na obrazovce“, počet kliknutí ani počet vytvořených AI artefaktů. Bude optimalizovat odstraněnou práci, kvalitu zpětné vazby a schopnost učitele jednat včas.
...
**Rozhodnutí:** Eduto smí využívat AI pro návrhy, sumarizaci, přípravu, překlady, vysvětlení, doporučení a detekci pracovních signálů. Konečná pedagogická rozhodnutí, disciplinární rozhodnutí, zásadní klasifikace a rozhodnutí s významným dopadem na dítě zůstávají pod smysluplnou lidskou kontrolou.
...
„AI Operating System for Schools“ je silné interní vyjádření ambice, ale nesmí předstírat, že Eduto nahradí všechny systémy školy. To by bylo nevěrohodné, kapitálově destruktivní a strategicky chybné.

## 2.2 Co Eduto nahrazuje a co nenahrazuje
...
To je jádro Eduta. Test, kvíz, materiál, parťák, oznámení ani AI nejsou samostatným produktem. Jsou uzly této smyčky.
...
> Eduto propojí třídy, materiály, testování a komunikaci tak, aby učitel zadával informace jednou a opakující se práce proběhla automaticky pod jeho kontrolou.

## 3.2 Pro ředitele

> Eduto škole vrací čas, sjednocuje pedagogická workflow nad stávající infrastrukturou a dává vedení důkaz, že úkoly, informace a podpora skutečně doputovaly tam, kam měly.

## 3.3 Pro rodiče

> Eduto vás upozorní jen na to, co je pro vaše dítě důležité, ve srozumitelném jazyce a s jasnou akcí.

## 3.4 Pro žáka

> Eduto ti ukáže, co máš dělat dál, vysvětlí chybu bez ponižování a porovnává tě především s tvým vlastním pokrokem.
...
Eduto bude architektonicky připraven na:
...
> Eduto se stane výchozí inteligentní workflow vrstvou pro významnou část českých škol a nástrojem, který učitelé otevírají pravidelně, protože odstraňuje práci a propojuje to, co už používají.
...
To nevytváří automaticky trh pro Eduto. Vytváří to pouze velký počet potenciálních uživatelů. Skutečný adresovatelný trh vznikne až kombinací:
...
Exportovatelnou hodnotou Eduta musí být:
...
Eduto nesmí vyhrát všech pět kategorií. Musí být vrstvou, která přes ně zajišťuje konkrétní workflow a přidává školní kontext.
...
Pro Eduto by bylo špatně, kdyby:
...
Pro Eduto je přijatelné, když:

- ForClassmates zůstane silnější ve výrobě samostatného obsahu;
- Eduto bude výrazně silnější v kontextu školy, workflow, integracích, guardian vazbách, auditovatelnosti a automatizaci následných kroků.
...
- Eduto musí vlastnit lokální kontext, orchestration a měřitelnou úsporu.
...
- většina zpráv vzniká mimo kontext Eduta;
...
# 21. Struktura budoucí „Eduto Book“
...
5. **Mapu systémů pilotní školy** — co zůstává v Google, co v SIS, co v Edutu.  
...
> **Eduto uspěje tehdy, když technologie zmizí do pozadí a škole zůstane více času na lidi.**
