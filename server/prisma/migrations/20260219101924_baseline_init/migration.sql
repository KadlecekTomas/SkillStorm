...
-- CreateEnum
CREATE TYPE "public"."PermissionKey" AS ENUM ('CREATE_TEST', 'EDIT_TEST', 'DELETE_TEST', 'VIEW_RESULTS', 'MANAGE_STUDENTS', 'MANAGE_TEACHERS', 'VIEW_ANALYTICS', 'INVITE_STUDENTS', 'INVITE_TEACHERS', 'VIEW_TEST_OVERVIEW', 'MANAGE_TESTS', 'ASSIGN_TESTS', 'VIEW_SUBMISSIONS', 'MANAGE_ASSIGNMENTS', 'VIEW_OWN_ASSIGNMENTS', 'VIEW_CLASS_ASSIGNMENTS', 'VIEW_ORG_ASSIGNMENTS');
...
-- CreateIndex
CREATE INDEX "assignments_academic_year_id_idx" ON "public"."assignments"("academic_year_id");
...
-- AddForeignKey
ALTER TABLE "public"."password_reset_tokens" ADD CONSTRAINT "password_reset_tokens_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."enrollments" ADD CONSTRAINT "enrollments_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("organization_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."assignments" ADD CONSTRAINT "assignments_academic_year_id_fkey" FOREIGN KEY ("academic_year_id") REFERENCES "public"."academic_years"("academic_year_id") ON DELETE CASCADE ON UPDATE CASCADE;
