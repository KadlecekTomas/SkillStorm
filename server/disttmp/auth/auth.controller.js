...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.refresh = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.refreshAccessToken(dto.refreshToken)];
                });
            });
        };
        AuthController_1.prototype.logout = function (req, refreshToken) {
            return __awaiter(this, void 0, void 0, function () {
                var accessToken;
                var _a;
                return __generator(this, function (_b) {
                    accessToken = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(' ')[1];
                    return [2 /*return*/, this.authService.logout(accessToken, refreshToken)];
                });
            });
        };
        AuthController_1.prototype.me = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.getUserProfile(req.user.userId)];
                });
            });
        };
    ...
    (function () {
        ...
        _register_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({ summary: 'Register a new user' })];
        _login_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Login user' })];
        _refresh_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('refresh'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Refresh access token' })];
        _logout_decorators = [(0, common_1.Post)('logout'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        _me_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiOperation)({ summary: 'Get current user profile' })];
