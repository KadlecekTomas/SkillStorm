...
exports.SetHomeroomDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var SetHomeroomDto = function () {
    var _a;
    var _teacherId_decorators;
    var _teacherId_initializers = [];
    var _teacherId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function SetHomeroomDto() {
                this.teacherId = __runInitializers(this, _teacherId_initializers, void 0);
                __runInitializers(this, _teacherId_extraInitializers);
            }
            return SetHomeroomDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _teacherId_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    example: 'teacher-uuid',
                    description: 'Učitel, který bude třídní. Pokud undefined/null → třídnictví se zruší.',
                    nullable: true,
...
exports.SetHomeroomDto = SetHomeroomDto;
