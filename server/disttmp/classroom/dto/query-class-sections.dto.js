...
exports.QueryClassSectionsDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var class_transformer_1 = require("class-transformer");
var client_1 = require("@prisma/client");
var QueryClassSectionsDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function QueryClassSectionsDto() {
                ...
                this.search = (__runInitializers(this, _grade_extraInitializers), __runInitializers(this, _search_initializers, void 0));
            ...
            return QueryClassSectionsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _yearId_decorators = [(0, swagger_1.ApiProperty)({ description: 'Školní rok', example: 'year-uuid' }), (0, class_validator_1.IsUUID)()];
            _grade_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: client_1.SchoolGrade, example: 'PRIMARY_1' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.SchoolGrade)];
...
exports.QueryClassSectionsDto = QueryClassSectionsDto;
