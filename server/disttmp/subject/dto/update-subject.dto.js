...
var UpdateSubjectDto = function () {
    ...
    return _a = /** @class */ (function () {
            function UpdateSubjectDto() {
                ...
                this.catalogSubjectId = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _catalogSubjectId_initializers, void 0));
        ...
        (function () {
            ...
            _name_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'Matematika – rozšířená' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(2, 120), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
