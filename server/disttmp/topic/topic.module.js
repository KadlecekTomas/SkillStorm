...
var TopicsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            controllers: [topic_controller_1.TopicsController],
            providers: [topic_service_1.TopicsService, prisma_service_1.PrismaService],
            exports: [topic_service_1.TopicsService],
        })];
