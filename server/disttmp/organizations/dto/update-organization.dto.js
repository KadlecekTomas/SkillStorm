    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _name_decorators = [(0, swagger_1.ApiPropertyOptional)({
                ...
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(3, 255), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === null || value === void 0 ? void 0 : value.trim();
                })];
            _address_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'Komenského 99' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === null || value === void 0 ? void 0 : value.trim();
                })];
            _city_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'Brno' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
                    return value === null || value === void 0 ? void 0 : value.trim();
                })];
