...
export function validateEnvironment(): void {
  ...
  validateProductionSecret('JWT_REFRESH_SECRET', process.env.JWT_REFRESH_SECRET);
  validateProductionSecret('METRICS_INGEST_KEY', process.env.METRICS_INGEST_KEY);
...
function validateProductionSecret(name: string, value: string | undefined): void {
