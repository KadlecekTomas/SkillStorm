...
export const HEALTH_PLAYBOOK: Record<HealthRecommendationCode, PlaybookEntry> = {
  NO_TEACHER_ACTIVITY: {
    ...
    actions: [
      ...
      {
        label: 'Kontaktuj ředitele a ověř onboarding učitelů — možná potřebují školení nebo přihlašovací údaje.',
        type: 'TEXT',
        value: 'Kontaktuj ředitele a ověř onboarding učitelů — možná potřebují školení nebo přihlašovací údaje.',
      },
    ],
  },
  ...
  NO_STUDENT_ACTIVITY: {
    ...
    actions: [
      ...
      {
        label: 'Zkontroluj, zda jsou třídy a žáci importováni a zda existují otevřená zadání.',
        type: 'TEXT',
        value: 'Zkontroluj, zda jsou třídy a žáci importováni a zda existují otevřená zadání.',
      },
    ],
  },
  ...
  NO_NEW_CONTENT: {
    ...
    actions: [
      ...
      {
        label: 'Ověř, zda učitelé mají přístup k tvorbě testů a zda je catalog aktivovaný.',
        type: 'TEXT',
        value: 'Ověř, zda učitelé mají přístup k tvorbě testů a zda je catalog aktivovaný.',
      },
    ],
  },
  ...
  LOW_INVITE_CONVERSION: {
    ...
    actions: [
      ...
      {
        label: 'Zkontroluj expiraci invite odkazů a onboarding copy. Zvažte prodloužení platnosti nebo jiný komunikační kanál.',
        type: 'TEXT',
        value: 'Zkontroluj expiraci invite odkazů a onboarding copy. Zvažte prodloužení platnosti nebo jiný komunikační kanál.',
      },
    ],
  },
  ...
  AT_RISK: {
    ...
    actions: [
      ...
      {
        label: 'Zvažte přímý kontakt s ředitelem organizace pro zjištění příčiny inaktivity.',
        type: 'TEXT',
        value: 'Zvažte přímý kontakt s ředitelem organizace pro zjištění příčiny inaktivity.',
      },
    ],
  },
};
