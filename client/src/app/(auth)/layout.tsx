        ...
        >
          ...
          <div className="my-auto">
            ...
            <p className="mt-3 text-slate-500">
              Bezpečné přihlášení pro učitele, žáky a vedení školy.
            </p>

            <ul className="mt-6 space-y-3 text-sm text-slate-600">
              <li>• Rychlé a bezpečné přihlášení</li>
              <li>• Přehled o aktivitě uživatelů</li>
              <li>• Ochrana dat v souladu s GDPR</li>
            </ul>
          </div>
          ...
          <div className="flex items-center gap-3 text-sm text-slate-500">
            <Button variant="ghost" asChild className="text-slate-600">
              <Link href="/register">
                Vytvořit účet nebo se připojit ke škole
              </Link>
            </Button>
          </div>
        </motion.section>
