...
import { getMyStudentProgress } from "@/lib/student-progress";
...
function StudentProgressPanel({
  ...
  data: StudentProgressDetail | null;
  loading: boolean;
  error: string | null;
}): React.JSX.Element {
  if (loading) {
...
export function StudentDashboard(): React.JSX.Element {
  ...
  const [schoolProgress, setSchoolProgress] = useState<StudentProgressDetail | null>(null);
