 ...
 *   nelze vyhodnotit strojově); NENÍ to „propadnutí“ žáka. Backend nemá
 *   doložený workflow ručního dohodnocení (jediný přechod na finální skóre je
 *   automatické APPROVED), proto label neslibuje ruční kontrolu, kterou systém
 *   neprovede. Viz submissions.service.ts (unscorableQuestionIds).
 */
export const SUBMISSION_STATUS_LABELS: Record<string, string> = {
  PENDING: "Čeká na vyhodnocení",
  APPROVED: "Vyhodnoceno",
  REJECTED: "Nepodařilo se automaticky vyhodnotit",
};
